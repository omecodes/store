...
func (b *BaseHandler) PutObject(ctx context.Context, object *pb.Object, security *pb.PathAccessRules, opts oms.PutDataOptions) (string, error) {
	return b.next.PutObject(ctx, object, security, opts)
}

func (b *BaseHandler) GetObject(ctx context.Context, id string, opts oms.GetObjectOptions) (*pb.Object, error) {
...
func (b *BaseHandler) ListObjects(ctx context.Context, opts oms.ListOptions) (*pb.ObjectList, error) {
...
func (b *BaseHandler) SearchObjects(ctx context.Context, params oms.SearchParams, opts oms.SearchOptions) (*pb.ObjectList, error) {
