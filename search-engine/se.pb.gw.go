...
func request_SearchEngine_Feed_0(ctx context.Context, marshaler runtime.Marshaler, client SearchEngineClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func RegisterSearchEngineHandlerServer(ctx context.Context, mux *runtime.ServeMux, server SearchEngineServer) error {
	...
	mux.Handle("POST", pattern_SearchEngine_Feed_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
...
func RegisterSearchEngineHandlerClient(ctx context.Context, mux *runtime.ServeMux, client SearchEngineClient) error {
	...
	mux.Handle("POST", pattern_SearchEngine_Feed_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/.SearchEngine/Feed")
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_SearchEngine_Feed_0(rctx, inboundMarshaler, client, req, pathParams)
		...
		forward_SearchEngine_Feed_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	pattern_SearchEngine_Feed_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"SearchEngine", "Feed"}, ""))

	pattern_SearchEngine_Search_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"SearchEngine", "Search"}, ""))
)

var (
	forward_SearchEngine_Feed_0 = runtime.ForwardResponseMessage
