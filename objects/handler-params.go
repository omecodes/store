...
func (p *ParamsHandler) GetObject(ctx context.Context, collection string, id string, opts GetOptions) (*pb.Object, error) {
	if collection == "" || id == "" {
...
func (p *ParamsHandler) SearchObjects(ctx context.Context, collection string, query *pb.SearchQuery) (*Cursor, error) {
